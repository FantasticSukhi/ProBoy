...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        kb.append([InlineKeyboardButton(text='Support', url='https://t.me/+3PbzY0xoNEczNjRl'),
    ...
    return [
        [
            InlineKeyboardButton(
                ...
                url='https://t.me/+3PbzY0xoNEczNjRl',
            ),
            InlineKeyboardButton(
        ...
        if mod_match:
            ...
            help_buttons.append(
                [
                    ...
                    InlineKeyboardButton(text='Support', url='https://t.me/+3PbzY0xoNEczNjRl')
                ]
                    )
